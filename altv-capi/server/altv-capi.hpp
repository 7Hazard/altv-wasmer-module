...
// cpptype enum alt::IBaseObject::Type
// enumaral type
CAPI enum alt_IBaseObject_Type alt_IColShape_GetType(struct alt_IColShape* _instance);
...
// enumaral type
// cpptype class alt::Vector<float, 3, class alt::PointLayout>
CAPI struct alt_IBlip* alt_IServer_CreateBlip(struct alt_IServer* _instance, struct alt_IPlayer* target, enum alt_IBlip_Type type, struct alt_Vector_float_3_PointLayout* pos);
